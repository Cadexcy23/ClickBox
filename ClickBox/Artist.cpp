...
int Artist::SCREEN_WIDTH = 800;
int Artist::SCREEN_HEIGHT = 450;
...
SDL_Texture* Artist::gClickAttackX = NULL;
//letters
...
bool Artist::init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("Click Box", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, Artist::SCREEN_WIDTH, Artist::SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		Artist artist;
	...
	//put further loading functions here
	object.loadObjectMasterList();
	player.loadPlayer();
...
bool Artist::loadMedia()
{
	...
	//Load texture
	Artist::gClickAttackX = loadTexture("Resource/clickAttackX.png");
...
void Artist::draw()
{
	...
	//SDL_RenderDrawLine(gRenderer, 0, 0, 1920, 1080);
